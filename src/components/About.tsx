      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-6">We Build the Infrastructure for Your Growth</h2>
            <div className="space-y-4 text-muted-foreground text-lg">
              <p>
                Aumco Consulting was founded to bridge the gap between business ideas and sustainable revenue. We don't just consult; we build the systems that drive growth.
              </p>
              <p>
                Our approach combines data-driven performance marketing with robust sales systems and legal compliance, ensuring your business is built on a solid foundation.
              </p>
              <p>
                Whether you're a startup looking for your first 100 customers or an MSME ready to automate your operations, our team provides the execution power you need to scale.
              </p>
            </div>
